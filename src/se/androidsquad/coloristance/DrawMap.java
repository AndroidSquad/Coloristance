...
public class DrawMap extends View { // Creates a custom view that paints a filled rectangle 
	...
	protected void onDraw(Canvas canvas) {
		...
		//Test
		for(int i = 0; i<2 ;i++){ // Loopen är felaktig. 2:an bör ersättas med rectId[i].length
			for(int j = 0; j<2 ;j++){ //Loopen är felaktig. 2:a bör ersättas med dynamiskt värde
				...
				colorList[i][j].setColor(RectModel.getRectColor()); // Ersätt konstant med typ MapModel.getRoomColor(rectId[0][0])
